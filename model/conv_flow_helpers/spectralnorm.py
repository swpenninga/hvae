...
# Slight variation of the standard SpectralNormalization wrapper
# https://github.com/keras-team/keras/blob/v3.8.0/keras/src/layers/normalization/spectral_normalization.py#L9
# Added masking and removed InputSpec


class MaskedSpectralNormalization(Wrapper):
    ...
    def __init__(self, layer, mask=None, power_iterations=1, **kwargs):
    ...
    def normalized_weights(self):
        ...
        if self.mask is not None:
            m = ops.transpose(self.mask, [2, 3, 1, 0])
            weights = ops.reshape(self.kernel * m, [-1, self.kernel_shape[-1]])
        else:
